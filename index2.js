...
const token = '364844293:AAGiF4suudJcd9Xc-K1gmFBQ4Kw8R8h27r8';
	const keyboard_0 = [
		['Прайс',
		'Выбор услуг',
...
//	const time = (typeof(myCache4.get( "chatId" )) === 'undefined')? 'неопределено':myCache4.get( "chatId" );
	...
	const status = 'Сейчас Ваш заказ: '+getOrderText(order)+ ' на сумму '+getOrderSum(order)+' руб. Время приема '+day+' '+time; 
